...
#Bevor gestartet
# C:\GIT\_my-apps\python_pypostal> python -m spacy init fill-config config\base_config.cfg config\config.cfg
...
df_train=pd.read_csv(filepath_or_buffer="dataset/us-train-dataset.csv",sep=",",dtype=str)
...
doc_bin_train.to_disk("spacy-docbins/train.spacy")
######################################


###### Validation dataset prep ###########
# Read the validation dataset into pandas
df_test=pd.read_csv(filepath_or_buffer="dataset/us-test-dataset.csv",sep=",",dtype=str)
...
doc_bin_test.to_disk("spacy-docbins/test.spacy")
##########################################